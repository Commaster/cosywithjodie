$(function() {
  ...
  const entries = [
    ...
    "Jodie says 'Feck uff'",
    "Jodie drowns",
    "Jodie screams 'Lauren'",
    "Mods get bullied",
    "Jodie falls off her horse",
    "Jodie falls off a cliff",
    "Jodie buys a rug",
    "Jodie buys a divider",
    "Jodie buys Zeki balls",
    "Complaining about hoarding",
    "Chest storage full",
    "Jodie screams 'Moonage'",
    "Jodie accidentally chops a charging tree",
    "Jodie spends Guild coins",
